Basado en btrfs-progs de KDave (version muy preliminar):
...
Herramientas para el manejo de sistema de archivos Btrfs.
Licencia: GPLv2.

Btrfs es un sistema de archivos de tipo "copy on write", usado últimamente en Linux, este tipo de sistemas de archivo, permiten el uso de copias maestras, y réplicas,
las cuales su modificación, nunca cambian la copia original. Aunque su verdadero potencial, son las características avanzadas enfocadas a tolerancia a fallos, formas 
de reparación y una administración sencilla.

Este repositorio alberga las siguientes utilidades, así como la documentación necesaria:

* **btrfs** &mdash; la herramienta principal de administración ([pagina manual en ingles](https://btrfs.readthedocs.io/en/latest/btrfs.html))
* **mkfs.btrfs** &mdash; utilidad para crear un sistema de archivos btfrs ([pagina manual en ingles](https://btrfs.readthedocs.io/en/latest/mkfs.btrfs.html))
* Binarios "todo en uno" tipo busybox con mkfs.btrfs, btrfs-image y otras herramientas incorporadas ([herramientas estándar](https://btrfs.readthedocs.io/en/latest/btrfs.html#standalone-tools))
* **libbtrfsutil** (LGPL v2.1) &mdash; veriones en C y python 3 [libbtrfsutil/README.md](libbtrfsutil/README.md) leer si se necesita más información
* páginas del manual, y documentación, en inglés, publicadas en [btrfs.readthedocs.io](https://btrfs.readthedocs.io) (RTD)

Ver [INSTALL](INSTALL) para instrucciones de compilacion, [tests/README.md](tests/README.md) para información sobre pruebas y [ci/README.md](ci/README.md) sobre mejoras a añadir (Integración Continua)

Información, aún sin traducir:
==============================
